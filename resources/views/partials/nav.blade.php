                    ...
                    <div class="flex relative pr-6">
                        ...
                        <div class="relative text-sm">
                            <button id="userButton" class="flex items-center focus:outline-none mr-3">
                                <img class="w-8 h-8 rounded-full mr-4" src="{{ asset('imgs/user.jpg') }}" alt="Avatar of User"> <span class="hidden md:inline-block">Hi, <b class="font-sm text-indigo-400 font-bold">{{ auth()->user()->name }}</b> </span>
