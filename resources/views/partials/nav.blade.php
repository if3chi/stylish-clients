                    ...
                    <div class="flex relative pr-6">
                        ...
                        <div class="relative text-sm">
                            <button id="userButton" class="flex items-center focus:outline-none mr-3">
                                <img class="w-8 h-8 rounded-full mr-4" src="{{ asset('imgs/user.jpg') }}" alt="Avatar of User"> <span class="hidden md:inline-block">Hi, <b class="text-indigo-400 font-bold">{{ explode(' ', Auth::user()->name)[0] }}</b> </span>
                            ...
                            <div id="userMenu" class="bg-white nunito rounded shadow-md mt-2 absolute top-0 right-0 min-w-full overflow-auto z-30 invisible">
                                <ul class="list-reset">
                                    <li><a href="#" class="px-4 py-2 block text-gray-900 hover:bg-indigo-400 hover:text-white no-underline hover:no-underline">{{ __('My account') }}</a></li>
                                    <li><a href="#" class="px-4 py-2 block text-gray-900 hover:bg-indigo-400 hover:text-white no-underline hover:no-underline">{{ __('Notifications') }}</a></li>
                                    <li>
