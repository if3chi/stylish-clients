<div id="sidebar" class="h-screen w-16 menu bg-white text-white px-4 flex items-center nunito  fixed shadow">

    <ul class="list-reset ">
        <li class="my-2 md:my-0">
            <a href="{{ route('dashboard') }}" class="block py-1 md:py-3 pl-1 align-middle text-gray-600 no-underline hover:text-indigo-400">
                <i class="fas fa-chart-pie fa-fw mr-3 {{ request()->routeIs('dashboard') ? 'text-indigo-400' : '' }}"></i><span class="w-full inline-block pb-1 md:pb-0 text-sm">{{ __('Home') }}</span>
            </a>
        </li>
        <li class="my-2 md:my-0 ">
            <a href="{{ route('clients.index') }}" class="block py-1 md:py-3 pl-1 align-middle text-gray-600 no-underline hover:text-indigo-400">
                <i class="fas fa-users fa-fw mr-3 {{ request()->routeIs('clients.index') ? 'text-indigo-400' : '' }}"></i><span class="w-full inline-block pb-1 md:pb-0 text-sm">{{ __('Clients') }}</span>
            </a>
        </li>
        {{-- <li class="my-2 md:my-0">
