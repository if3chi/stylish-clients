    ...
    <header class="bg-white shadow w-full flex-wrap text-indigo-800 tracking-wide font-bold">
        <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
            <div class="flex flex-row justify">
                ...
                <span class="sm:ml-3">
                    <button wire:click="getForm" type="button"
                        class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-indigo-700 bg-white hover:bg-gray-100 focus:outline-none focus:ring-2 border-indigo-600 focus:ring-offset-2 focus:ring-indigo-500">
                        <x-icon.user-plus />
                        {{ __('Add New Client') }}
                    </button>
                </span>
                                ...
                                @forelse ($clients as $client)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    <img class="h-10 w-10 rounded-full" src="{{ $client->image_url }}"
                                                        alt="">
                                                </div>
                                                <div class="ml-4">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <div class="text-sm text-gray-500">
                                                {{ 'Birthday in: ' . $client->due_birthday . ' Days.' }}</div>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="6" class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="flex flex-col justify-center">
                                                ...
                                                <span class="mt-4">
                                                    <div wire:click="getForm" type="button"
                                                        class="inline-flex cursor-pointer items-center px-3 py-2 shadow-sm text-sm font-medium text-indigo-700 bg-white hover:bg-gray-100 border border-indigo-600 rounded-md">
                                                        <x-icon.user-plus />
                                                        {{ __('Add New Client') }}
                                                    </div>
                                                </span>
